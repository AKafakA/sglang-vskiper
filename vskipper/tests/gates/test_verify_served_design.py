...
tree is importable -- i.e. a serving host, not the code box.
    ...
    /opt/vpipe/venv/bin/python vskipper/tests/gates/test_verify_served_design.py
"""
...
GATE = TREE / "vskipper/src/vskipper/experiments/gates/verify_served_design.py"
ARM = "vskipper"
...
def main() -> int:
    ...
    from vskipper.runtime import design as d
    from vskipper.runtime.common import resolved_design_attestation
