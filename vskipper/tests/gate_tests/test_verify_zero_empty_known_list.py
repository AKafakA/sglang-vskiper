...
GATE = ROOT / "vskipper/src/vskipper/experiments/gates/verify_zero_empty.py"
KNOWN = json.loads((ROOT / "vskipper/src/vskipper/experiments/gates/known_empties.json").read_text())
...
def test_the_accounting_validator_consults_the_same_known_list():
    ...
    src = (ROOT / "vskipper/src/vskipper/experiments/validate_qps_artifact.py").read_text()
