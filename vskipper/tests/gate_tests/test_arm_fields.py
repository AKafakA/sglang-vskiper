...
def test_llama_arms_keep_the_served_design():
    from vskipper.runtime import design
    from vskipper.runtime.config import full_graph_layer_policies
...
def test_ablation_and_qwen_arms_declare_their_fields():
    ...
    from vskipper.runtime.config import full_graph_compact_config, full_graph_layer_policies
...
def test_hard_mask_payload_semantics_are_attested():
    from vskipper.runtime.skipper import FlexiDepthFullGraphAdapter
...
def test_qwen_arm_band_follows_the_rule_with_its_own_inputs():
    from vskipper.runtime import design
    from vskipper.runtime.roofline import arm_kv_rule_inputs, assert_kv_band_follows_rule, derived_kv_band
...
def test_qwen_sharedband_arm_is_a_declared_deviation():
    ...
    from vskipper.runtime import design
    from vskipper.runtime.roofline import arm_kv_rule_inputs, assert_kv_band_follows_rule
...
def test_every_device_band_is_the_rule_output_for_the_served_arm():
    ...
    from vskipper.runtime import design
    from vskipper.runtime.roofline import arm_kv_rule_inputs, band_device_key, derived_kv_band
...
def test_qwen3_8b_arm_band_follows_the_rule_with_its_own_inputs():
    ...
    from vskipper.runtime import design
    from vskipper.runtime.roofline import arm_kv_rule_inputs, derived_kv_band
