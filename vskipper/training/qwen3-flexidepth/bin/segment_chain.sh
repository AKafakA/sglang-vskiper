...
# [D-828, owner 2026-09-16] EARLY STOP: any task below stock - 10 pp at ANY gate stops the chain; model of record = last passing checkpoint.
sys.exit(10 if miss else 0)
PY
  local rc=$?
