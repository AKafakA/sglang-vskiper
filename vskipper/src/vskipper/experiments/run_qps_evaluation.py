...
def _runner_environment(
    ...
    required = [str(ROOT / "vskipper/src"), str(ROOT / "python"), str(ROOT / "vskipper/src/vskipper/experiments")]
    inherited = [
        path
...
GATES = ROOT / "vskipper/src/vskipper/experiments/gates"
...
def _run_cell(
    ...
    sampler_command = [
        sys.executable,
        str(ROOT / "vskipper/src/vskipper/experiments/sample_sglang_load.py"),
        "--base-url",
    ...
    audit_command = [
        sys.executable,
        str(ROOT / "vskipper/src/vskipper/experiments/validate_qps_artifact.py"),
        "--bench-jsonl",
        str(output_file),
        "--expected-requests",
        str(requested_count),
    ...
    score_command = [
        sys.executable,
        str(ROOT / "vskipper/src/vskipper/experiments/score_labeled_workload.py"),
        "--bench-jsonl",
        str(output_file),
        "--metadata",
        str(metadata_path),
