...
export PYTHONPATH="$ROOT/vskipper/src:$ROOT/python:$ROOT/vskipper/src/vskipper/experiments:$ROOT/vskipper/src/vskipper/analysis${PYTHONPATH:+:$PYTHONPATH}"
...
for path in \
  ...
  "$EXPECTED_RUNTIME" \
  "$QPS_CONFIG" \
  "$ROOT/vskipper/src/vskipper/experiments/launch_qps_server.py" \
  "$ROOT/vskipper/src/vskipper/experiments/run_qps_evaluation.py" \
  "$ROOT/vskipper/src/vskipper/experiments/validate_runtime_after.py"; do
  if [[ ! -e "$path" ]]; then
...
if [[ -n "$EVALUATION_CONTRACT" ]]; then
  "$PYTHON_BIN" "$ROOT/vskipper/src/vskipper/experiments/run_qps_evaluation.py" \
...
"$PYTHON_BIN" "$ROOT/vskipper/src/vskipper/experiments/launch_qps_server.py" \
...
"$PYTHON_BIN" "$ROOT/vskipper/src/vskipper/experiments/run_qps_evaluation.py" "${evaluation_args[@]}"
"$PYTHON_BIN" "$ROOT/vskipper/src/vskipper/experiments/validate_runtime_after.py" \
