...
def _load_known_empties() -> dict[str, dict[str, Any]]:
    """request_id -> entry from vskipper/src/vskipper/experiments/gates/known_empties.json; fails closed without a witness."""
...
def validate_record(
    ...
    *,
    ...
    # truth, vskipper/src/vskipper/experiments/gates/known_empties.json): an empty the CHECKPOINT ITSELF produces under
