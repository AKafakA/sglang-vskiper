...
TREE="${VP_GATE_TREE:-$TREE}"
printf '%s\n' "$ARM" > "$TREE/vskipper/configs/deploy/active_arm"
export SGLANG_VP_HOST_CONFIG="${SGLANG_VP_HOST_CONFIG:-$TREE/vskipper/configs/deploy/hosts/vast-a100.json}"
CRASHES=0
