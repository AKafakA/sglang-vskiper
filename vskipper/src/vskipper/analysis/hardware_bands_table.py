...
HERE = os.path.dirname(os.path.abspath(__file__)); VP = os.path.join(HERE, "..", "runtime")
sys.path.insert(0, VP)
import roofline  # noqa: E402

NAMES = {"NVIDIA_A100": ("A100-SXM4-80GB", "AHundred"), "NVIDIA_A100_40GB": ("A100-SXM4-40GB", "AHundredForty"),
