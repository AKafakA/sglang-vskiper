...
from vskipper.runtime.design import (  # [D-609] the design is code
...
from vskipper.runtime.types import (
...
from vskipper.runtime.kv_commit import (
    _device_key,
    _trace_counter,
    _fdvp_state,
    _fdvp_trace_enabled,
...
class FullGraphDeviceRouteTape:
    ...
    def action_mask_fused(
        ...
        from vskipper.runtime.routing import route_decide_and_maps
...
def regime_switch_config(
    ...
    if design["decode"].get("enter_kv_tokens", 0) > 0 and torch.cuda.is_available():
        from vskipper.runtime.design import SERVED_DECODE_KV_BAND_BY_DEVICE
        from vskipper.kernels.kernel import canonical_device_key

        from vskipper.runtime.roofline import band_device_key
