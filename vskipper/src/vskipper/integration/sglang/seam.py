...
from vskipper.runtime.design import (  # [D-609] design/host paths are code
    active_arm_name,
    design_attestation,
...
from vskipper.runtime.env import SERVED_MODEL_REVISION_ENV
...
from vskipper.runtime.executor import (
...
def maybe_fd_layer_forward(layer, positions, hidden_states, forward_batch, residual):
    ...
    if layer.fd_router is not None and forward_batch.vp_seam_batch_eager:
        ...
        from vskipper.runtime.eager import fd_layer_forward_eager
