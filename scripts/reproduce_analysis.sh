...
python3 $VP/sweep_prediction.py --no-occupancy-bars --sweep fixed=generated/sweep --occupancy fixed=generated/sweep_occupancy_fixed.json --sweep rule=generated/sweep_v2 --occupancy rule=generated/sweep_occupancy_rule.json --sweep ungated=generated/sweep_ungated --occupancy ungated=generated/sweep_occupancy_ungated.json --suite $SUITE --png figures/sweep_prediction.pdf --rows generated/sweep_cells_rows.tex --macros generated/sweep_prediction_macros.tex 2>&1 | tail -1
python3 $VP/sweep_heatmap.py generated/sweep_v2 --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E mean" --title "per-policy thresholds" --png figures/sweep_heatmap_v2_mean.pdf --macros ./scratch/sweep_v2_mean.tex --macro-prefix vpSweepTwo | tail -1
python3 $VP/sweep_heatmap.py generated/sweep --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E mean" --title "shared thresholds" --png figures/sweep_heatmap_mean.pdf --macros ./scratch/sweep_mean.tex | tail -1
python3 $VP/sweep_heatmap.py generated/sweep_ungated --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E mean" --title "always route" --png figures/sweep_heatmap_ungated_mean.pdf --macros ./scratch/sweep_ung_mean.tex --macro-prefix vpSweepUng | tail -1
python3 $VP/sweep_heatmap.py generated/sweep --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E p99" --title "shared thresholds, p99" --png figures/sweep_heatmap_p99.pdf --macros ./scratch/sweep_p99.tex | tail -1   # App. I: the p99 companion of the shared-threshold map
python3 $VP/sweep_heatmap.py generated/sweep_ungated --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E p99" --title "always route, p99" --png figures/sweep_heatmap_ungated_p99.pdf --macros ./scratch/sweep_ung_p99.tex | tail -1   # App. I three-panel p99
python3 $VP/sweep_heatmap.py generated/sweep_v2 --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E p99" --title "per-policy thresholds, p99" --png figures/sweep_heatmap_v2_p99.pdf --macros ./scratch/sweep_v2_p99.tex --macro-prefix vpSweepTwo | tail -1
...
say "5c Qwen rows (D-830, o8192 budget D-834): Qwen3-4B hybrid (3 reps, Q*=17) + shared Llama thresholds (1 rep); Qwen3-8B, three checkpoints (3 reps each, Q*=14)"
...
[ -f $QW/qwen4b_shared_gsm8k_q4b/paired_report.upstream_g1024__vskipper_qwen3_4b_sharedband.json ] && python3 $VP/paper_table.py $QW/qwen4b_shared_gsm8k_q4b/paired_report.upstream_g1024__vskipper_qwen3_4b_sharedband.json --knee gsm8k_q4b=17 --emit --columns main --dataset-label "Qwen3-4B (Llama thresholds)" --macros ./scratch/qwen4bs_macros.tex --macro-prefix vpQwenFourShr > generated/qwen_sharedband_rows.tex && cat ./scratch/qwen4bs_macros.tex >> generated/qwen_serving_macros_v16.tex && echo "  Qwen3-4B shared thresholds: $(grep -c '\\\\' generated/qwen_sharedband_rows.tex) rows"
