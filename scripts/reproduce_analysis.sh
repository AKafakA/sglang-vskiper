...
python3 $VP/sweep_heatmap.py generated/sweep_v2 --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E mean" --title "per-policy thresholds" --png figures/sweep_heatmap_v2_mean.png --macros ./scratch/sweep_v2_mean.tex --macro-prefix vpSweepTwo | tail -1
python3 $VP/sweep_heatmap.py generated/sweep --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E mean" --title "shared thresholds" --png figures/sweep_heatmap_mean.png --macros ./scratch/sweep_mean.tex | tail -1
...
python3 $VP/sweep_heatmap.py generated/sweep --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E p99" --title "shared thresholds, p99" --png figures/sweep_heatmap_p99.png --macros ./scratch/sweep_p99.tex | tail -1   # App. I: the p99 companion of the shared-threshold map
python3 $VP/sweep_heatmap.py generated/sweep_ungated --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E p99" --title "always route, p99" --png figures/sweep_heatmap_ungated_p99.png --macros ./scratch/sweep_ung_p99.tex | tail -1   # App. I three-panel p99
python3 $VP/sweep_heatmap.py generated/sweep_v2 --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E p99" --title "per-policy thresholds, p99" --png figures/sweep_heatmap_v2_p99.png --macros ./scratch/sweep_v2_p99.tex --macro-prefix vpSweepTwo | tail -1
