...
python3 $VP/sweep_heatmap.py generated/sweep --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E p95" --title "shared thresholds, p95" --png figures/sweep_heatmap_p95.png --macros ./scratch/sweep_p95.tex | tail -1   # App. H: the p95 companion of the shared-band map
...
python3 $VP/sweep_heatmap.py generated/sweep_v2 --dataset gsm8k --suite $SUITE --headline generated/paired_report.json --metrics "E2E p95" --title "per-policy thresholds, p95" --png figures/sweep_heatmap_v2_p95.png --macros ./scratch/sweep_v2_p95.tex --macro-prefix vpSweepTwo | tail -1
