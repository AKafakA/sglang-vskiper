"""Stage SCROLLS validation splits to local jsonl for offline (HPC cluster) loading.
The cluster has no outbound SSL, so the archived hf_hub_download path cannot run there."""
