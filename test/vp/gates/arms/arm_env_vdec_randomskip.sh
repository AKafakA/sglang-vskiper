...
export SGLANG_VP_FULL_GRAPH_SKIPPER=deterministic_mock
export SGLANG_VP_FULL_GRAPH_MOCK_TOKEN_SKIP_RATE=0.5
export SGLANG_VP_FULL_GRAPH_MOCK_SKIPPED_DEPTH_RATIO=0.5
export SGLANG_VP_FULL_GRAPH_MOCK_SEED=1234
