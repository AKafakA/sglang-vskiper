...
```bash
TRAINING="$PWD/training/qwen3-flexidepth"
...
compares every tensor. Follow [GPU measurements](../../docs/vskipper/02-run-experiments.md)
for the matched-work serving protocol and [analysis](../../docs/vskipper/03-run-analysis.md)
...
```bash
python training/qwen3-flexidepth/data/prepare_qwen3_training_data.py \
...
python training/qwen3-flexidepth/train/sft_qwen3.py --help
```
